...
public final class SelfHostnameVerifier implements HostnameVerifier {
    ...
    private  List<String> ignoreVerifyHost;
    
    private final Log log = LogFactory.getLog(getClass());

    private final PublicSuffixMatcher publicSuffixMatcher;

    public SelfHostnameVerifier(final PublicSuffixMatcher publicSuffixMatcher) {
        this.publicSuffixMatcher = publicSuffixMatcher;
    }

    public SelfHostnameVerifier(final List<String> ignoreVerifyHost) {
        this.publicSuffixMatcher=PublicSuffixMatcherLoader.getDefault();
        this.ignoreVerifyHost=ignoreVerifyHost;
    }
    ...
    public boolean verify(final String host, final SSLSession session) {
        try {
        	//=========自定义证书的host不进行验证=======//
        	if(ignoreVerifyHost!=null && host!=null){
        		for (String  ignoreHost: ignoreVerifyHost) {
					if(ignoreHost!=null && ignoreHost.equalsIgnoreCase(host)){
						return true;
					}
				}
        	}
