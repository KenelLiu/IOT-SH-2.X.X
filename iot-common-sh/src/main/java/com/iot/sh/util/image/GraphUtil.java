package com.iot.sh.util.image;

import com.iot.sh.exception.ImageException;
...
public class GraphUtil {
	 ...
	 * @throws ImageException
	 */
	public static void  addBackgroundForTransparentImage(String srcPath,String outPath) throws ImageException {
		try(InputStream in= Files.newInputStream(Paths.get(srcPath));
			...
			BufferedImage outImg=new BufferedImage(srcWidth,srcHeight,BufferedImage.TYPE_INT_RGB);
