...
public class HttpResponse implements Serializable {
	...
	public String getResponseText()  throws HttpResponseException {
		return getResponseText(null);
	}
	
	public String getResponseText(String charset) throws HttpResponseException {
		...
		try{
			...
			throw new HttpResponseException(ex.getMessage(), ex);
		}
	}
