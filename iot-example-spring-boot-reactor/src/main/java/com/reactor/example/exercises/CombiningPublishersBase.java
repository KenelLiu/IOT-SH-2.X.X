...
public class CombiningPublishersBase {
   ...
   protected  AtomicBoolean localCacheCalled = new AtomicBoolean(false);
   protected  AtomicInteger consumedSpamCounter = new AtomicInteger(0);
   protected  AtomicBoolean fileOpened = new AtomicBoolean(false);
   protected  AtomicBoolean writtenToFile = new AtomicBoolean(false);
   protected  AtomicBoolean fileClosed = new AtomicBoolean(false);
   protected  AtomicInteger committedTasksCounter = new AtomicInteger(0);
