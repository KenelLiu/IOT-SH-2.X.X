package com.example.cloud.config.websocket;
...
import com.example.cloud.config.websocket.second.WebSocketInterceptor;
import com.example.cloud.config.websocket.second.WebSocketMessageHandler;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer{
    ...
    /**
     * 开启websocket
     * 第一种方式  @bean ServerEndpointExporter+{@link com.example.cloud.config.websocket.second.IOTWebSocket}
     * 
     * @return
     */
    //@Bean
