package com.iot.example.boot.config.websocket;

import com.iot.example.boot.config.websocket.second.IOTWebSocket;
import com.iot.example.boot.config.websocket.second.WebSocketInterceptor;
import com.iot.example.boot.config.websocket.second.WebSocketMessageHandler;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer{
    ...
    /**
     * 开启websocket
     * 第一种方式  @bean ServerEndpointExporter+{@link IOTWebSocket}
     * 
     * @return
     */
    //@Bean
